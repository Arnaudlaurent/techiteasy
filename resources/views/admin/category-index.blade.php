...
<div class="row">
	...
	<div class="col-md-6 ">
		<div class="login-panel panel panel-default admin-content nomargintop">
			<div class="col-md-12">
				...
				<button type="submit" class="btn btn-lg btn-extia btn-block">Ajouter <i class="fa fa-plus"></i></button>
				{!! Form::close() !!}
			</div>
		</div>
	</div>
	...
	<div class="col-md-6 ">
		<div class="login-panel panel panel-default admin-content 2 nomargintop">
			...
			<button type="submit" class="btn btn-lg btn-extia btn-block"> Modifier <i class="fa fa-check"></i></button>
			{!! Form::close() !!}
		</div>
	</div>
</div>
